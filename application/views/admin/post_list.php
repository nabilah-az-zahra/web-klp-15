...
<body>
	<main class="main">
		...
		<div class="articlelist">
			<h1 class="articlelisttitle">List Artikel</h1>

			<div class="articlelistbtn">
				<a href="<?= site_url('admin/post/new') ?>" role="button">+ Tulis Artikel</a>
			</div>
			...
			<table class="articlelisttable">
				...
				<tbody>
					...
					<tr>
						...
						<?php endif ?>
						<td>
							<div class="articlelistaction">
								<a href="<?= site_url('article/'.$article->slug) ?>" class="articlelistpreviewbtn" target="_blank" role="button">Preview</a>
								<a href="<?= site_url('admin/post/edit/'.$article->id) ?>" class="articlelisteditbtn" role="button">Edit</a>
								<a href="#" 
									data-delete-url="<?= site_url('admin/post/delete/'.$article->id) ?>" 
									class="articlelistdeletebtn" 
									role="button"
